...
<body>
	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<?php if ($_SESSION['mail']!=NULL){?>

				<div id="form3">
					<div class="titulo5">CREAR UNA CUENTA</div><!--formulario creacion de cuenta-->
						<form method="post" action="valiusuario.php" name="crear_cuenta" id="registrado2">
						
						<div><input type="text" name="nombre" placeholder="Ingrese Nombre y apellido" size="40px"></div>
						<div><input type="text" name="edad" placeholder="Ingrese Edad" size="40px"></div>
						<div><input type="text" name="mail" placeholder="Ingrese Correo electrónico" size="40px"></div>
						<div><input type="text" name="direccion" placeholder="Ingrese Dirección de envio" size="40px"></div>
						<div><input type="text" name="localidad" placeholder="Ingrese localidad" size="40px"></div>
						<div><input type="text" name="provincia" placeholder="Ingrese Provincia" size="40px"></div>
						
						
						<div><input type="password" name="pass" placeholder="Ingrese Contraseña" size="40px"></div>
						<div><input type="password" name="pass2" placeholder="Confirme Contraseña" size="40px"></div><br>
						<div><input type="submit" name="enviar" value="Registrarme" style="width:100px; height:25px;"></div>
					</form>
				</div>
				...
				<div id="form1">
					<div class="titulo">INICIAR SESION</div> <!--formulario de inicio de sesion-->
					<form method="post" action="validalogin.php" name="registrado" id="registrado">
						<div><input type="text" name="mail" placeholder="Ingrese correo electrónico" size="40px"></div>
						<div><input type="password" name="pass" placeholder="Ingrese contraseña" size="40px"></div><br>
						<div><input type="submit" name="enviar" value="Ingresar" style="width:100px; height:25px;"></div>
					</form>
					
				</div>
				<div id="form2">
					<div class="titulo2">CREAR UNA CUENTA</div><!--formulario creacion de cuenta-->
						<form method="post" action="valiusuario.php" name="crear_cuenta" id="registrado2">
			...
			<div id="footer">
				...
				<div id="pie2">
				<div id="social">
				<div class="fb"><a href="http://www.facebook.com" target="_blank"><img src="../img/social/facebook.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				<div class="google"><a href="https://plus.google.com/" target="_blank"><img src="../img/social/googleplus.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				<div class="insta"><a href="http://www.instagram.com" target="_blank"><img src="../img/social/instagram.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				
				<div class="share"><a href="http://www.facebook.com" target="_blank"><img src="../img/social/share.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				<div class="tw"><a href="http://www.twitter.com" target="_blank"><img src="../img/social/twitter.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				<div class="you"><a href="http://www.youtube.com" target="_blank"><img src="../img/social/youtube.png" border="0" width="30px" height="30px" alt="fcbk"/></a></div>
				</div>
				</div>
