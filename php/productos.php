...
<body>
	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				$con="SELECT * FROM disco"; //realiza consulta en la tabla disco
				require "mysql.php";
				while ($f=mysqli_fetch_array($consulta)) { //devuelve resultados
					
				?>
					<div class="uno">
					<a href="disco.php?disco=<?php echo $f['iddisco'];?>"> <!--devuelve resultado de la consulta y lo muestra en un link-->
				    <img src="../files/<?php echo $f['portada'];?>" width="150px" height="150px" alt="<?php echo $f['nombre_d'];?>"/></a></div>
