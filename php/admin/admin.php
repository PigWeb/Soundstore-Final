	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<div id="resultados_busqueda"><br/><br/>
					<div class="titulo3">PANEL DE CONTROL</div>
					<br>
					
					<?php if(isset($_SESSION['admin'])){?>
						<div id="admin1"><?php
						echo "<form action='admin-usr.php'>
    							<input type=submit value='Administracion de Usuarios' name='buy'>
								</form>";?>
						</div>
						<div id="admin1"><?php
						echo "<form action='admin-disco.php'>
    							<input type=submit value='Administracion de Discos' name='buy'>
								</form>";?>
						</div>
						<div id="admin1"><?php		
						echo "<form action='admin-compras.php'>
    							<input type=submit value='Ver compras realizadas' name='buy'>
								</form>";?>
						</div><?php		
					}?>
					  
					<div><input type='button' value='Manual De Administrador' name='Back2' onclick="location.href='../../Soundstore - Administrador.pdf'"/></div>
