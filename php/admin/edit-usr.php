	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<ul class="dropdown">
					...
					<br/><br/>
					<div class="titulo3">PANEL DE CONTROL - USUARIOS</div>
					<br>
										
				<div id="form1">
					<div class="titulo">INFORMACION DEL USUARIO</div> <!--formulario de inicio de sesion-->
					<?php $mail=$_GET["mail"];
						  $con="CALL conusr('$mail')";
						  require ("../mysql.php");

						while($resultados=mysqli_fetch_array($consulta)){
						echo "<br/><br/>";
						echo "Nombre: ".$resultados['nomape']."<br />";
   						echo "Edad: ".$resultados['edad']."<br />";
   						echo "Direccion de email: ".$resultados['email']."<br />";
   						echo "Direccion: ".$resultados['direccion']."<br />";
   						echo "Localidad: ".$resultados['localidad']."<br />";
   						echo "Provincia: ".$resultados['provincia']."<br />";
   					}
					?>
				</div>
				<div id="form2">
					<div class="titulo2">EDITAR CUENTA</div><!--formulario creacion de cuenta-->
						
						<form method="post" action="update-usr.php" name="crear_cuenta" id="registrado2">
						<div><input type="hidden" name="mail" value="<?php echo $mail;?>"/></div>
