		...
		<div id="contenido">
				...
				<ul class="dropdown">
					...
					<?php
							if($_SESSION['admin']==1){
					?>
							<li><a href="admin.php"class="dir">ADMINISTRADOR</a></li>
					<?php   }
					?>
					...
					<br/><br/>
					<div class="titulo3">PANEL DE CONTROL - DISCOS</div>
					<br>
										
				<div id="form1">
					<div class="titulo">INFORMACION DEL DISCO</div> <!--formulario de inicio de sesion-->
					<?php $d=$_GET["Id"];
						  $con="CALL disco('$d')";
						  require ("../mysql.php");
						while($resultados=mysqli_fetch_array($consulta)){
						echo "<br/><br/>";
						echo "Nombre del disco: ".$resultados['nombre_d']."<br />";
   						echo "Artista: ".$resultados['artista']."<br />";
   						echo "Genero: ".$resultados['genero']."<br />";
   						echo "Precio: ".$resultados['precio']."<br />";
   						echo "Formato: ".$resultados['formato']."<br />";
   						echo "Nombre del archivo de imagen: ".$resultados['portada']."<br />";
   						echo "Nombre del archivo de sonido: ".$resultados['tema_preview']."<br />";
   						echo "Nombre del tema de muestra: ".$resultados['nombretpre']."<br />";
   					}
					?>

				</div>
				<div id="form4">
					<div class="titulo4">EDITAR DISCO</div><!--formulario creacion de cuenta-->
						<form method="post" action="update-disc.php" name="crear_cuenta" id="registrado2" enctype="multipart/form-data">
						<div><input type="hidden" name="iddisco" value="<?php echo $d;?>"/></div>
						<div><input type="text" name="nombred" placeholder="Ingrese Nombre del disco" size="40px"></div>
						<div><input type="text" name="artista" placeholder="Ingrese Artista" size="40px"></div>
						<div><input type="text" name="genero" placeholder="Ingrese el genero del artista" size="40px"></div>
						<div><input type="text" name="precio" placeholder="Ingrese el precio" size="40px"></div>
						<div><input type="text" name="formato" placeholder="Ingrese Formato del disco" size="40px"></div>
						<div><input type="text" name="nomimg" placeholder="Ingrese el nombre del archivo de imagen" size="40px"></div>
						<div><input type="hidden" name="MAX_FILE_SIZE" value="10000000"></div>
						<div class="boton"><input name="img" type="file" class="boton1">Subir archivo imagen</div>
						<div><input type="text" name="nommp3" placeholder="Ingrese el nombre del archivo de sonido" size="40px"></div>
						<div><input type="text" name="nompre" placeholder="Ingrese el nombre del tema de muestra" size="40px"></div>
						<div><input type="hidden" name="MAX_FILE_SIZE" value="10000000000"></div>
						<div class="boton"><input name="mp3" type="file" class="boton1">Subir archivo de muestra</div>
						<div><?php echo "*Todos los datos son obligatorios"?></div>
						<div><input type="submit" name="enviar" value="Actualizar info" style="width:100px; height:25px;"></div>
					</form>
				</div>
