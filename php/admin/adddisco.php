...
<body>
	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<div id="form3">
					<div class="titulo3">AGREGAR DISCO</div><!--formulario creacion de cuenta-->
						<form method="post" action="add-disco.php" name="crear_cuenta" id="registrado2" enctype="multipart/form-data">
						<div><input type="text" name="iddisco" placeholder="Ingrese el Id del disco" size="40px"/></div>
						<div><input type="text" name="idart" placeholder="Ingrese el Id del artista" size="40px"/></div>
						...
						<div class="boton99"><input name="img" type="file" class="boton10">Subir archivo imagen</div>
						...
						<div class="boton99"><input name="mp3" type="file" class="boton10">Subir archivo de muestra</div>
						<div><?php echo "*Todos los datos son obligatorios"?></div>
						<div><input type="submit" name="enviar" value="Agregar disco" style="width:100px; height:25px;"></div>
					</form>
				</div>
