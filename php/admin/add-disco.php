		...
		<div id="contenido">
				...
				<div id="resultados_admin"><br/><br/>
					...
					<?php 
						...
						if($Id =="" or $Idarti =="" or $ndisco == "" or $artist == "" or $genero=="" or $precio=="" or $formato=="" or 
							$nomimg=="" or $nmp3=="" or $npre==""){ 
						...
						$con="CALL adddi('$Id','$Idarti','$ndisco','$artist','$genero','$precio','$formato','$nomimg','$nmp3','$npre')";
						require("../mysql.php");
						if($consulta!='0')
							echo "El disco ha sido correctamente agregado";
						mysqli_close($conexion); 
						
						}
						else{ 
						echo "Disco no agregado. <br/>";
