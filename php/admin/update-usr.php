		...
		<div id="contenido">
				...
				<div id="resultados_admin"><br/><br/>
					...
					<?php 
						...
						if($nombre =="" or $email == "" or $dire == "" or $edad==""){ 
						...
						$con="UPDATE `store`.`usuario` SET `nomape`='$nombre', 
						`edad`='$edad', `direccion`='$dire', `localidad`='$locali',`provincia`='$pcia', `admin`='$admin'
						WHERE `email`='$email'";
						//CALL updusr('$nombre','$edad','$dire','$locali','$pcia','$p1','$admin','$email')
						require("../mysql.php");
						if($consulta!='0')
