				...
				<div id="resultados_admin"><br/><br/>
					...
					<?php 
							echo "<form action='../login.php'>
    							<input type=submit value='Agregar un usuario nuevo' name='buy'>
								</form>";
							echo "<br/>";
						...
						for($i=0;$i<count($arreglo);$i++){
							$tabla2='<tr>
								  ...
								  <td>'.$arreglo[$i]['Localidad'].'</td>
								  <td>'.$arreglo[$i]['Provincia'].'</td>
								  <td><a href="eliminar-usr.php?mail='.$arreglo[$i]['Email'].'">
				    					<img src="../../img/delete.png" width="20px" height="20px"/></a>
				    				  <a href="edit-usr.php?mail=' .$arreglo[$i]['Email'].'">
