...
<body>
	...
	<div id="contenido">
				...
				<div id="resultados_busqueda"><?php
						
						$activo=$_SESSION['activo'];

						if ($activo==NULL) {
								echo "<br/>No has iniciado sesion!<br/><br/>";
						...
						$Provincia=$_SESSION['pcia'];
						?>
						<br/>
						<div class="titulo3">MI CUENTA</div>
						<div id="form1">
						<br>
						<?php
						...
						echo "Edad: ".$Edad."<br/>";
						echo "Direccion de e-mail: ".$Mail."<br/>";
						...
						<br><br>
						<?php
						echo "Tu ubicacion en el mapa: <br/>";
						echo "<img src='http://maps.googleapis.com/maps/api/staticmap?zoom=15&size=200x200&sensor=false&maptype=roadmap&markers=size:mid%7Ccolor:red%7C".$Direccion.",".$Localidad.",".$Provincia."'/><br/>";
						echo "<form action='cerrar.php'>
    							<input type=submit value='Cerrar sesion' name='logoff'>
								</form>";
						?></div><?php	
						}?>
				
				</div><input type='button' value='VOLVER A LA PAGINA PRINCIPAL' name='Back2' onclick="location.href='../index.php'"/>	
	</div>	
