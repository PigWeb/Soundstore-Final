	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<ul class="dropdown">
					...
					<li><a href="productos.php" class="dir">PRODUCTOS</a></li>
          ...
          <div class="titulo3">RESULTADOS DE LA BUSQUEDA</div><?php
            ...
            //busqueda de discos
						...
						while($resultados=mysqli_fetch_array($consulta)){  //devuelve resultados en forma de array 
   						...
   						echo '<a href="disco.php?disco='.$resultados['iddisco'].'">ir a la pagina del disco</a>'; //link dinamico que vuelve a la pagina del disco
   						echo "<br>";
   						}
   						...
   						$con="CALL search2('%$d%')";
						  require ("mysql.php");
						  echo "Resultados de artistas con la palabra: $d <br><br>";						
						  while($resultados=mysqli_fetch_array($consulta)){ 
   						...
   						echo "formato: ".$resultados['formato']."<br />";
   						echo "precio: $".$resultados['precio']."<br />";
   						echo '<a href="disco.php?disco='.$resultados['iddisco'].'">ir a la pagina del disco</a>';
   						echo "<br>";
   						}
        ...
        <input type='button' value='VOLVER A LA PAGINA PRINCIPAL' name='Back2' onclick="location.href='../index.php'"/> <!--devuelve a la pagina pcipal-->
