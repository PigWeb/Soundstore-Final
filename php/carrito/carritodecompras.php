...
if(isset($_SESSION['mail'])){	
	if(isset($_SESSION['carrito'])){
		//si ya existe la la sesion 'carrito', entra a la condicion
		if(isset($_GET['iddisc'])){
					//Guarda elementos de la sesion 'carrito' en el arreglo
					$arreglo=$_SESSION['carrito'];
					$encontro=false;
					$numero=0;
					//recorre el arreglo
					for($i=0;$i<count($arreglo);$i++){
						//compara el Id enviado por parametro con los Ids cargados en el arreglo
						if($arreglo[$i]['Id']==$_GET['iddisc']){
							$encontro=true;
							$numero=$i;
						}
					}
					//si los Ids coinciden suma 1 a la variable 'cantidad'
					if($encontro==true){
						$arreglo[$numero]['Cantidad']=$arreglo[$numero]['Cantidad']+1;
						$_SESSION['carrito']=$arreglo;
					}
					//sino carga un nuevo elemento en el array
					else{
						$nombre="";
						$precio=0;
						$imagen="";
						...
						//crea un array con datos nuevos
						$datosNuevos=array('Id'=>$_GET['iddisc'],
										'Nombre'=>$nombre,
										'Precio'=>$precio,
										'Imagen'=>$imagen,
										'Cantidad'=>1);
						//suma el nuevo array al array existente 
						array_push($arreglo, $datosNuevos);
						//actualiza la sesion 'carrito' con los datos agregados
						$_SESSION['carrito']=$arreglo;
	...
	//crea la sesion carrito cuando se agrega un elemento por primera vez
	else{
		if(isset($_GET['iddisc'])){
			$nombre="";
			$precio=0;
...
<body>
	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<ul class="dropdown">
					...
					<li><a href="carritodecompras.php" class="dir">SHOP</a></li>
	...
	?>
				<div class="unoc">
						<img src="../../files/<?php echo $datos[$i]['Imagen'];?>" width="150px" height="150px"/><br>
	...
	{?>
					<div id="carrito">No has añadido ningun producto!</div>
	<?php	}}else{
	
	?>					<div id="carrito">No has iniciado sesion<br/>
						<form action='../login.php'>
    					<input type=submit value='Iniciar sesion' name='logon'>
						</form></div>
	<?php   }
			echo '<center><h2><id="total">Total: '.$total.'</h2></center>';
			if($total!=0){
					echo "<a href='compras.php'><img src='../../img/buy.png' width='300px' height='100px'/></a>";
					echo "<form action='vaciarcarrito.php'>
    							<input type=submit value='Vaciar carrito' name='logoff'>
								</form>";
						}
	?>		

				</div>
				<br><input type='button' value='Ver catalogo' name='catalog' onclick="location.href='../productos.php'"/><br>
				<input type='button' value='Volver a la Pagina Principal' name='Back2' onclick="location.href='../../index.php'"/>
