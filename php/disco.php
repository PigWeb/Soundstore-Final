...
<body>
	...
	<div id="encabezado"> 
		...
		<div id="contenido">
				...
				<div id="resultados_busqueda"><br/><br/>
					<div class="titulo3">INFO</div><?php
						$d=$_GET["disco"]; //recibe el id del disco por medio de GET						
						$con="CALL disco('$d')"; //llama stored precedure que selecciona por Id de disco 
						require ("mysql.php"); //llama archivo php
												
						while($resultados=mysqli_fetch_array($consulta)){ //muestra resultados de la consulta 
   						?>
   						<div id="form1">
						<br>
						<br/>
						<?php
   						...
   						echo "Tema preview del disco ".$resultados['nombre_d'].", ".$resultados['nombretpre']." ";
						echo "<br/><br/><a href='../files/".$resultados['tema_preview']."' target='_blank'><img src='../img/boton_play_orange.png' width='80px' height='80px'/></a>";
   						
   						?></div>
   						<div id="form2">
						<br><br>
						<?php
						echo "<img src='../files/".$resultados['portada']."' width='150px' height='150px'/><br/>";
						echo "<br/><a href='carrito/carritodecompras.php?iddisc=" .$resultados['iddisco']."'>
				    	<img src='../img/carrito.png' width=80px' height='80px'/></a>";
						}
