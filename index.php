...
<head>
		...
		<script>
			...
			//Comienzo Jquery slider principal
	...
	<div id="contenedor">
		<div id="encabezado"> 
			...
			<div id="search"> <!--buscador-->
				<form method="post" action="php/busqueda.php" name="busqueda">
		...
		<div id="contenido">
					...
					<ul class="dropdown"><!--Menu horizontal-->
						...
						<li><a href="php/carrito/carritodecompras.php" class="dir">Shop</a></li>
						<li><a href="php/productos.php" class="dir">PRODUCTOS</a>
						</li>
						
						<li><a href="php/cuenta.php" class="dir">MI CUENTA</a>
						<ul>
							
						</ul>
						</li>
						<li><a href="php/login.php" class="dir">ACCEDER/REGISTRARSE</a></li>
						<li><a href="php/about.php" class="dir">ABOUT</a></li>
											<?php
							if($_SESSION['admin']==1){
					?>
							<li><a href="php/admin/admin.php"class="dir">ADMINISTRADOR</a></li>
					<?php   }
					?>
				...
				<!--Inicio Slider-->
				<div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:960px; height:500px; overflow: hidden;">
			
					<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:960px; height:500px; overflow: hidden;">
					<div>
						<img u="image" src="img/jim.jpg" />
						<div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:400px; height:60px;"> 
						ARTISTA DEL MES 
						</div>
					</div>
					<div>
						<img u="image" src="img/foo.jpg" />
						<div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:400px; height:60px;"> 
						ULTIMAS NOVEDADES
						</div>
					</div>
					<div>
						<img u="image" src="img/dj4.jpg" />
						<div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:400px; height:60px;"> 
					...
					<!-- Arrow Left -->
					<span u="arrowleft" class="jssora02l" style="width: 55px; height: 55px; top: 230px; left: 8px;">
					</span>
					<!-- Arrow Right -->
					<span u="arrowright" class="jssora02r" style="width: 55px; height: 55px; top: 230px; right: 8px;">
					</span>
